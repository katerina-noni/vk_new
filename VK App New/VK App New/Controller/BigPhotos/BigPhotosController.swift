...
class BigPhotosController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        bigPhotoImageView.kf.setImage(with: URL(string: photos[selectedPhotoIndex].imageFull))
    ...
    @objc func viewPanned(_ panGestureRecognizer: UIPanGestureRecognizer){
        ...
        case .began:
            if panGestureRecognizer.translation(in: view).x > 0 {
                ...
                additionalImageView.kf.setImage(with: URL(string: photos[selectedPhotoIndex - 1].imageFull))
                // движение направо
                ...
                propertyAnimator.addCompletion{ position in
                    ...
                    case .end:
                        ...
                        self.bigPhotoImageView.kf.setImage(with: URL(string: self.photos[self.selectedPhotoIndex].imageFull))
